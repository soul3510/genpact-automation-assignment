...
Architecture (Github + C# SDK + Playwright + Test structure): 
------------
##########################################################
...
├── Pages/             
- Task 1: PlaywrightWikiPage.cs

├── Services/           
- Task 1: MediaWikiApiClient.cs

├── Tests/             
- Task 1: DebuggingFeaturesTests.cs

└── Utils/              
- Task 1: TextNormalizer.cs
...
├── Pages/              
- Task 2: PlaywrightWikiPage.cs, MicrosoftDevelopmentToolsLinkValidationResult.cs
...
├── Pages/          
- Task 3: PlaywrightWikiPage.cs, AppearanceColorState.cs
